                                        ...
                                        if (funcParams) {
                                            ...
                                            if (refFunc && refFunc.length > 1) {
                                                ...
                                                refFunc.forEach(f => {
                                                    ...
                                                    if (
                                                        !statics.RESERVED_FUNCTIONS.includes(func)
                                                    ) {
                                                        // TODO: improve this?
                                                        functions.push(func);
                                                    }
                ...
                for (let file = 0; file < aRoutes.length; file++) {
                    ...
                    if (data.split(',').length == 1) {
                        ...
                        for (
                             ...
                             */
                            if (
                                listOfFileName[idxFileName].split(new RegExp('new\\s+')).length > 1
                            ) {
                                if (listOfFileName[idxFileName].slice(-1)[0] == ')') {
                                    listOfFileName[idxFileName] = listOfFileName[idxFileName].slice(
                                        0,
                                        -1
                                    );
                                }
                    ...
                    for (let idxFileName = 0; idxFileName < listOfFileName.length; ++idxFileName) {
                        ...
                        let idx = importedFiles.findIndex(
                            e =>
                                e.varFileName && obj.varFileName && e.varFileName == obj.varFileName
                        );
